...
public class MainMenu {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            choice = sc.nextInt();
            sc.nextLine(); // 2. FIXED: Clears the buffer so nextLine() works in other classes!
            ...
            switch (choice) {
                ...
                case 7:
                    // Note: If EventManagement needs the scanner, change this to: event.addEvent(sc);
                    event.addEvent();
                    break;

                case 8:
                    System.out.println("Thank You");
                    sc.close(); // 3. Good practice: Close your scanner before exiting
                    System.exit(0);
                    break;
